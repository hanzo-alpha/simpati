...
const Api = {
    ...
    AnnouncementController: Object.assign(
        AnnouncementController,
        AnnouncementController,
    ),
    ShiftSwapController: Object.assign(
        ShiftSwapController,
        ShiftSwapController,
    ),
    AttendanceCorrectionController: Object.assign(
        AttendanceCorrectionController,
        AttendanceCorrectionController,
    ),
    EventPresensiController: Object.assign(
        EventPresensiController,
        EventPresensiController,
    ),
    StatisticController: Object.assign(
        StatisticController,
        StatisticController,
    ),
    SimpegIntegrationController: Object.assign(
        SimpegIntegrationController,
        SimpegIntegrationController,
    ),
};
