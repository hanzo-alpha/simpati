 ...
 * @see app/Http/Controllers/Web/AdminController.php:32
 * @route '/admin'
 */
 ...
 * @see app/Http/Controllers/Web/AdminController.php:232
 * @route '/admin/offices'
 */
 ...
 * @see app/Http/Controllers/Web/AdminController.php:241
 * @route '/admin/offices'
 */
export const storeOffice = (
    options?: RouteQueryOptions,
 ...
 * @see app/Http/Controllers/Web/AdminController.php:264
 ...
 * @see app/Http/Controllers/Web/AdminController.php:147
 * @route '/admin/users'
 */
 ...
 * @see app/Http/Controllers/Web/AdminController.php:167
 * @route '/admin/users'
 */
 ...
 * @see app/Http/Controllers/Web/AdminController.php:196
 ...
 * @see app/Http/Controllers/Web/AdminController.php:225
 ...
 * @see app/Http/Controllers/Web/AdminController.php:160
 ...
 * @see app/Http/Controllers/Web/AdminController.php:287
 ...
 */
export const exportAttendanceRecap = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
 ...
 * @route '/admin/attendances/export-recap'
 */
const exportAttendanceRecapForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
 ...
 * @route '/admin/attendances/export-recap'
 */
exportAttendanceRecapForm.head = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
 ...
 * @route '/admin/attendances/export-summary'
 */
const exportAttendanceSummaryForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
 ...
 * @route '/admin/attendances/export-summary'
 */
exportAttendanceSummaryForm.get = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
    action: exportAttendanceSummary.url(options),
    method: 'get',
 ...
 * @route '/admin/attendances/export-summary'
 */
exportAttendanceSummaryForm.head = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
...
updateLeaveRequest.url = (
    ...
    return (
        updateLeaveRequest.definition.url
...
destroySchedule.url = (
    ...
    return (
        destroySchedule.definition.url
            .replace('{schedule}', parsedArgs.schedule.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 * @see app/Http/Controllers/Web/AdminController.php:785
...
destroyAnnouncement.url = (
    ...
    return (
        destroyAnnouncement.definition.url
 ...
 * @route '/admin/announcements/{announcement}'
 */
destroyAnnouncementForm.delete = (
    args:
        | { announcement: number | { id: number } }
        | [announcement: number | { id: number }]
        | number
 ...
 * @see app/Http/Controllers/Web/AdminController.php:846
 * @route '/admin/shift-swaps/{shiftSwap}'
 */
export const updateShiftSwapStatus = (
    args:
...
updateShiftSwapStatus.url = (
    ...
    return (
        updateShiftSwapStatus.definition.url
 ...
 * @route '/admin/shift-swaps/{shiftSwap}'
 */
const updateShiftSwapStatusForm = (
    args:
        | { shiftSwap: number | { id: number } }
        | [shiftSwap: number | { id: number }]
        | number
 ...
 * @see app/Http/Controllers/Web/AdminController.php:861
 * @route '/admin/attendance-corrections'
 */
export const attendanceCorrections = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
    url: attendanceCorrections.url(options),
    method: 'get',
});

attendanceCorrections.definition = {
    methods: ['get', 'head'],
...
attendanceCorrections.url = (options?: RouteQueryOptions) => {
    return attendanceCorrections.definition.url + queryParams(options);
};
 ...
 * @route '/admin/attendance-corrections'
 */
const attendanceCorrectionsForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
    action: attendanceCorrections.url(options),
    method: 'get',
});
 ...
 * @route '/admin/attendance-corrections'
 */
attendanceCorrectionsForm.head = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
    action: attendanceCorrections.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        },
 ...
 * @see app/Http/Controllers/Web/AdminController.php:870
 * @route '/admin/attendance-corrections/{attendanceCorrection}'
 */
export const updateAttendanceCorrectionStatus = (
    args:
    ...
    url: updateAttendanceCorrectionStatus.url(args, options),
    method: 'put',
});

updateAttendanceCorrectionStatus.definition = {
    methods: ['put'],
 ...
 * @route '/admin/attendance-corrections/{attendanceCorrection}'
 */
updateAttendanceCorrectionStatus.url = (
    args:
        | { attendanceCorrection: number | { id: number } }
        | [attendanceCorrection: number | { id: number }]
        | number
    ...
    return (
        updateAttendanceCorrectionStatus.definition.url
            .replace(
                '{attendanceCorrection}',
 ...
 * @route '/admin/attendance-corrections/{attendanceCorrection}'
 */
updateAttendanceCorrectionStatus.put = (
    args:
        | { attendanceCorrection: number | { id: number } }
        | [attendanceCorrection: number | { id: number }]
        | number
 ...
 * @route '/admin/attendance-corrections/{attendanceCorrection}'
 */
const updateAttendanceCorrectionStatusForm = (
    args:
        | { attendanceCorrection: number | { id: number } }
        | [attendanceCorrection: number | { id: number }]
        | number
    ...
    action: updateAttendanceCorrectionStatus.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'PUT',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        },
 ...
 * @route '/admin/attendance-corrections/{attendanceCorrection}'
 */
updateAttendanceCorrectionStatusForm.put = (
    args:
        | { attendanceCorrection: number | { id: number } }
        | [attendanceCorrection: number | { id: number }]
        | number
 ...
 * @see app/Http/Controllers/Web/AdminController.php:1095
 * @route '/admin/events'
 */
export const events = (
    options?: RouteQueryOptions,
 ...
 * @see app/Http/Controllers/Web/AdminController.php:1117
 * @route '/admin/events'
 */
 ...
 * @see app/Http/Controllers/Web/AdminController.php:908
 ...
 * @see app/Http/Controllers/Web/AdminController.php:1001
 ...
 * @see app/Http/Controllers/Web/AdminController.php:1040
 * @route '/admin/settings'
 */
 ...
 * @see app/Http/Controllers/Web/AdminController.php:1084
 * @route '/admin/settings/test-simpeg'
 */
export const testSimpegConnection = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
 ...
 * @route '/admin/settings/test-simpeg'
 */
const testSimpegConnectionForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
