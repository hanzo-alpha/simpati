 ...
 * @see app/Http/Controllers/Web/AdminController.php:38
 * @route '/admin'
 */
 ...
 * @see app/Http/Controllers/Web/AdminController.php:238
 * @route '/admin/offices'
 */
 ...
 * @see app/Http/Controllers/Web/AdminController.php:247
 * @route '/admin/offices'
 */
 ...
 * @see app/Http/Controllers/Web/AdminController.php:260
 ...
 * @see app/Http/Controllers/Web/AdminController.php:153
 * @route '/admin/users'
 */
 ...
 * @see app/Http/Controllers/Web/AdminController.php:173
 * @route '/admin/users'
 */
 ...
 * @see app/Http/Controllers/Web/AdminController.php:202
 ...
 * @see app/Http/Controllers/Web/AdminController.php:166
 ...
 * @see app/Http/Controllers/Web/AdminController.php:273
 ...
 * @see app/Http/Controllers/Web/AdminController.php:798
 ...
 * @see app/Http/Controllers/Web/AdminController.php:814
 * @route '/admin/announcements/{announcement}'
 */
 ...
 * @see app/Http/Controllers/Web/AdminController.php:866
 ...
 * @see app/Http/Controllers/Web/AdminController.php:890
 ...
 * @see app/Http/Controllers/Web/AdminController.php:899
...
updateAttendanceCorrectionStatus.url = (args: { attendanceCorrection: number | { id: number } } | [attendanceCorrection: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    return updateAttendanceCorrectionStatus.definition.url
 ...
 * @see app/Http/Controllers/Web/AdminController.php:1098
 * @route '/admin/events'
 */
 ...
 * @see app/Http/Controllers/Web/AdminController.php:1120
 * @route '/admin/events'
 */
 ...
 * @see app/Http/Controllers/Web/AdminController.php:937
 ...
 * @see app/Http/Controllers/Web/AdminController.php:1030
 ...
 * @see app/Http/Controllers/Web/AdminController.php:1069
 * @route '/admin/settings'
 */
 ...
 * @see app/Http/Controllers/Web/AdminController.php:1087
...
const AdminController = { dashboard, offices, storeOffice, updateOffice, destroyOffice, users, storeUser, updateUser, toggleUser, resetDeviceBinding, attendances, exportAttendances, exportTppReport, exportAttendanceRecap, exportAttendanceSummary, verifyQrCode, leaveRequests, updateLeaveRequest, schedules, storeSchedule, updateSchedule, destroySchedule, announcements, storeAnnouncement, updateAnnouncement, destroyAnnouncement, shiftSwaps, updateShiftSwapStatus, attendanceCorrections, updateAttendanceCorrectionStatus, events, storeEvent, auditLogs, settings, updateSettings, testSimpegConnection }
