 ...
 * @see app/Http/Controllers/Web/AdminController.php:1104
 * @route '/admin/events'
 */
...
const AdminController = { dashboard, offices, storeOffice, updateOffice, destroyOffice, users, storeUser, updateUser, toggleUser, resetDeviceBinding, attendances, exportAttendances, exportTppReport, exportAttendanceRecap, exportAttendanceSummary, verifyQrCode, leaveRequests, updateLeaveRequest, schedules, storeSchedule, updateSchedule, destroySchedule, announcements, storeAnnouncement, destroyAnnouncement, shiftSwaps, updateShiftSwapStatus, attendanceCorrections, updateAttendanceCorrectionStatus, events, storeEvent, auditLogs, settings, updateSettings, testSimpegConnection }
