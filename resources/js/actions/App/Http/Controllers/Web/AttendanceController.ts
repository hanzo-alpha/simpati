 ...
 * @route '/peringkat'
 */
const peringkatd309dd143a9821b81999b84b0f69126b = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
 ...
 * @route '/peringkat'
 */
peringkatd309dd143a9821b81999b84b0f69126b.url = (
    options?: RouteQueryOptions,
) => {
    return (
        peringkatd309dd143a9821b81999b84b0f69126b.definition.url +
        queryParams(options)
    );
};
 ...
 * @route '/peringkat'
 */
peringkatd309dd143a9821b81999b84b0f69126b.get = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
    url: peringkatd309dd143a9821b81999b84b0f69126b.url(options),
    method: 'get',
 ...
 * @route '/peringkat'
 */
peringkatd309dd143a9821b81999b84b0f69126b.head = (
    options?: RouteQueryOptions,
 ...
 * @route '/peringkat'
 */
const peringkatd309dd143a9821b81999b84b0f69126bForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
 ...
 * @route '/peringkat'
 */
peringkatd309dd143a9821b81999b84b0f69126bForm.get = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
    action: peringkatd309dd143a9821b81999b84b0f69126b.url(options),
    method: 'get',
 ...
 * @route '/peringkat'
 */
peringkatd309dd143a9821b81999b84b0f69126bForm.head = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
...
peringkatd309dd143a9821b81999b84b0f69126b.form =
    peringkatd309dd143a9821b81999b84b0f69126bForm;
/**
 * @see \App\Http\Controllers\Web\AttendanceController::peringkat
 * @see app/Http/Controllers/Web/AttendanceController.php:138
 * @route '/admin/peringkat'
 */
const peringkatfe5c9d6e26cd4499906036fc9049b161 = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
 ...
 * @route '/admin/peringkat'
 */
peringkatfe5c9d6e26cd4499906036fc9049b161.url = (
    options?: RouteQueryOptions,
) => {
    return (
        peringkatfe5c9d6e26cd4499906036fc9049b161.definition.url +
        queryParams(options)
    );
};
 ...
 * @route '/admin/peringkat'
 */
peringkatfe5c9d6e26cd4499906036fc9049b161.get = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
    url: peringkatfe5c9d6e26cd4499906036fc9049b161.url(options),
    method: 'get',
 ...
 * @route '/admin/peringkat'
 */
peringkatfe5c9d6e26cd4499906036fc9049b161.head = (
    options?: RouteQueryOptions,
): RouteDefinition<'head'> => ({
    url: peringkatfe5c9d6e26cd4499906036fc9049b161.url(options),
    method: 'head',
 ...
 * @route '/admin/peringkat'
 */
const peringkatfe5c9d6e26cd4499906036fc9049b161Form = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
 ...
 * @route '/admin/peringkat'
 */
peringkatfe5c9d6e26cd4499906036fc9049b161Form.get = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
    action: peringkatfe5c9d6e26cd4499906036fc9049b161.url(options),
    method: 'get',
 ...
 * @route '/admin/peringkat'
 */
peringkatfe5c9d6e26cd4499906036fc9049b161Form.head = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
...
peringkatfe5c9d6e26cd4499906036fc9049b161.form =
    peringkatfe5c9d6e26cd4499906036fc9049b161Form;
 ...
 * @see app/Http/Controllers/Web/AttendanceController.php:208
 * @route '/presensi'
 */
