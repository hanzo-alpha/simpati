...
<template>
    ...
    >
        ...
        >
            <!-- Sidebar Header / Logo -->
            <div
                class="flex h-18 shrink-0 items-center border-b border-sidebar-border px-5"
            >
                <Link
                ...
                >
                    ...
                    >
                        <div
                            class="absolute -inset-1.5 rounded-full bg-emerald-500/25 blur-md transition-all group-hover:bg-emerald-500/40"
                        ></div>
                        <img
                    ...
                    <div>
                        <h2
                            class="bg-gradient-to-r from-emerald-400 via-emerald-300 to-teal-400 bg-clip-text font-sans text-xl leading-none font-black tracking-widest text-transparent uppercase transition-all group-hover:from-emerald-300 group-hover:to-teal-300"
                        >
                            SIMPATI
                        </h2>
                        <div class="mt-1 flex items-center gap-1.5">
                            <span
                                class="h-1.5 w-1.5 animate-pulse rounded-none bg-emerald-500"
                            ></span>
                            <span
            ...
            <nav class="flex-1 space-y-1 overflow-y-auto p-4">
                <p
                    class="mb-2 px-3 text-[10px] font-bold tracking-wider text-muted-foreground uppercase"
                >
                    Menu Utama
                </p>
                <SidebarLink
                ...
                <p
                    class="mt-5 mb-2 px-3 text-[10px] font-bold tracking-wider text-muted-foreground uppercase"
                >
                    Data Master
                </p>
                <SidebarLink
                ...
                <div class="flex w-full items-center justify-between">
                    <div>
                        <div class="flex items-center gap-2.5">
                            ...
                            <span
                                class="rounded-none border border-emerald-500/30 bg-emerald-500/10 px-2 py-0.5 font-mono text-[10px] font-bold tracking-wider text-emerald-600 uppercase dark:text-emerald-400"
                            >
                                OPERATIONAL
                            </span>
                        </div>
